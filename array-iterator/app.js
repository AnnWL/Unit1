...
const totalYearsLived = inventors.reduce(
  (yearSum, inventor) => yearSum + (inventor.passed - inventor.year),
  0
);
...
// Complete the exercise in the space below:
const travelMethodCounts = travelMethods.reduce((mtdCount, travelMtd) => {
  mtdCount[travelMtd] = (mtdCount[travelMtd] || 0) + 1;
  return mtdCount;
}, {});
